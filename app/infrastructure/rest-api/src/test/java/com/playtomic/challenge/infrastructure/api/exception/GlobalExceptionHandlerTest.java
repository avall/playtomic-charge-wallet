package com.playtomic.challenge.infrastructure.api.exception;

import com.playtomic.challenge.api.lib.model.ErrorDto;
...
import static com.playtomic.challenge.infrastructure.api.exception.GlobalExceptionHandler.MS_WALLET;
...
class GlobalExceptionHandlerTest {
  ...
  void givenException_whenRequestHttpMediaTypeNotAcceptable_thenReturnsErrorDto() {
    ...
    Assertions.assertEquals(CommonErrorMessage.REQUEST_NOT_ACCEPTABLE.getMessage(),
        errorDto.getMessage());
    Assertions.assertEquals(MS_WALLET, errorDto.getSource());
  }
  ...
  void givenException_whenMethodArgumentNotValid_thenReturnsErrorDto()
    ...
    Assertions.assertEquals(CommonErrorMessage.ARGUMENT_NOT_VALID.getCode(), errorDto.getCode());
    Assertions.assertEquals(
        "Validation failed for argument [0] in public void com.playtomic.challenge.infrastructure.api.exception.GlobalExceptionHandlerTest.exampleMethod(java.lang.String): [Error in object 'name': codes []; arguments []; default message [Name cannot be empty]] ",
        errorDto.getMessage());
    Assertions.assertEquals(MS_WALLET, errorDto.getSource());
  }
