...
import static com.playtomic.challenge.infrastructure.api.exception.ExceptionUtils.buildInvalidDetails;
...
public class GlobalExceptionHandler {
  ...
  public static final String MS_WALLET = "ms-wallet";

  @ResponseStatus(HttpStatus.BAD_REQUEST) // 400
  @ResponseBody
  @ExceptionHandler(PaymentGatewayException.class)
  public ErrorDto handlePaymentGatewayException(PaymentGatewayException e) {
    return ErrorDto.builder()
        .code(CommonErrorMessage.PAYMENT_GATEWAY_ERROR.getCode())
        .message(e.getMessage())
        .source(MS_WALLET).build();
  }
